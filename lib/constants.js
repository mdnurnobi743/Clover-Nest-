...
export const SPIN_SEGMENTS = [
    ...
    { id: 'cn_1',       type: 'cn',   label: '10–17 CN',  min: 10,  max: 17,  weight: 16.4 },
    { id: 'cn_2',       type: 'cn',   label: '18–25 CN',  min: 18,  max: 25,  weight: 16.4 },
    { id: 'cn_3',       type: 'cn',   label: '26–33 CN',  min: 26,  max: 33,  weight: 16.4 },
    { id: 'cn_4',       type: 'cn',   label: '34–41 CN',  min: 34,  max: 41,  weight: 16.4 },
    { id: 'cn_5',       type: 'cn',   label: '42–50 CN',  min: 42,  max: 50,  weight: 16.4 },
