...
export const SPIN_SEGMENTS = [
    ...
    { id: 'cn_1',       type: 'cn',   label: '0.01 CN', min: 0.01, max: 0.01, weight: 16.4 },
    { id: 'cn_2',       type: 'cn',   label: '10 CN',   min: 10,   max: 10,   weight: 16.4 },
    { id: 'cn_3',       type: 'cn',   label: '20 CN',   min: 20,   max: 20,   weight: 16.4 },
    { id: 'cn_4',       type: 'cn',   label: '30 CN',   min: 30,   max: 30,   weight: 16.4 },
    { id: 'cn_5',       type: 'cn',   label: '40 CN',   min: 40,   max: 40,   weight: 16.4 },
