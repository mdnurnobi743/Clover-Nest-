...
//
// ⚠️ RESTORED — this file is imported by api/user.js, api/earn.js and
// api/spin.js (`import { verifyTelegramInitData } from '../lib/telegramAuth.js'`)
// but the function had ended up living in lib/telegram.js instead (only its
// header comment said "lib/telegramAuth.js"), while lib/telegram.js's own
// Bot-API exports (tgSend, isMember, etc. — needed by api/bot.js, api/user.js,
// lib/referral.js) were missing entirely. Split back into the two files the
